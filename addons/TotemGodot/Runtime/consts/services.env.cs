...
namespace TotemConsts
{
    public static class ServicesEnv
    {
        ...
        public const string SmartContractAvatarsFilterName = "totem-common-files//filters//totem-avatar.json";
        public const string SmartContractItemsFilterName = "totem-common-files//filters//totem-item.json";
