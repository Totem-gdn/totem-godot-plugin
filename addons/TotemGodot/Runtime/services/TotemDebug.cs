...
namespace TotemServices
{
    ...
    public partial class TotemDebug : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            string pathToAssetOverride = "res://" + ServicesEnv.AssetsOverrideFilePath;
                ...
                foreach (var fieldNameValue in assetOverride.first_item_property_override)
                {
                    ...
                    if (field != null)
                    {
                        if (field.FieldType == typeof(Color))
                        {
                            ...
                            color = Color.FromString((string)fieldNameValue.Value, new Color(0, 0, 0, 1));
